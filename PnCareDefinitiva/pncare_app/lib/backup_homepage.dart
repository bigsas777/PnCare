...
class _HomePageState extends State<HomePage> {
  ...
  Future<List<Notizia>> _richiestaNotizie() async {
    ...
    for (var u in jsonData) {
      Notizia notizia = Notizia(u["Indice"], u["Titolo"], u["Descrizone"], u["Data"], u["Immagine"], u["Link"]);
      notizie.add(notizia);
    }

    print(notizie.length);
...
class Notizia {
  final int index;
  final String titolo;
  final String descrizone;
  final String data;
  final String immagine;
  final String link;

  Notizia(this.index, this.titolo, this.descrizone, this.data, this.immagine, this.link);
}
